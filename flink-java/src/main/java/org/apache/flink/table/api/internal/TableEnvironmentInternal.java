...
public interface TableEnvironmentInternal extends TableEnvironment {
    ...
    default TableResult executeInternal(String jobName, List<ModifyOperation> operations) {
        return executeInternal(operations);
    }
    ...
    default TableResult executeInternal(String jobName, Operation operation) {
