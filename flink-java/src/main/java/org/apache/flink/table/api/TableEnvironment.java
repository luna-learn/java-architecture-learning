...
public interface TableEnvironment {
    ...
    default Table sqlQuery(String jobName, String query) {
    ...
    default TableResult executeSql(String jobName, String statement) {
    ...
    default FunctionCatalog getFunctionCatalog() {
        return null;
    }

    Table createTable(QueryOperation tableOperation);
